 ...
 */
UCLASS()
class MODULARGAMEPLAYEXPERIENCES_API UAsyncAction_ExperienceReady : public UBlueprintAsyncActionBase
{
...
private:
	...
	void Step3_HandleExperienceLoaded(const UModularExperienceDefinition* CurrentExperience);
